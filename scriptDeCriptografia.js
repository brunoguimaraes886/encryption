...
document.getElementById('botaoChave').style.background = 'red'
...
function setar() {
    ...
    if (chaveS.value < 1 || chaveS.value > 25 || chaveS.value.length == 0) {
        ...
        document.getElementById('botaoChave').style.background = 'green'
        function codificar() {
            /*function verificarChave() {
                if (chaveS.value < 1 || chaveS.value > 25 || chaveS.value.length == 0) {
                 window.alert("Verifique o valor posto na chave!");
             }}
             setInterval(verificarChave, 10000)*/
            if (chaveS.value > 25){
                chaveS.value = 25
            } else if (chaveS.value < 1) {
                chaveS.value = 1
            }
        ...
        setInterval(codificar, 1)
        setInterval(decodificar, 1)
    }
}